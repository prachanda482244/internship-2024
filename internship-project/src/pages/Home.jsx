...
const Home = () => {
    return (
        <div >
            <Background />
            <div className="max-w-7xl h-screen bg-white mx-auto  flex flex-col  lg:flex-row border shadow-md relative z-10 ">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="p-6 sm:self-center">
                        <img width={600} height={400} src={middleImage} alt="" />
                    </div>
                </div>
                <div>
                    <div className="bg-yellow-500 p-4">
                        <h1 className="text-xl tracking-tight uppercase font-semibold text-slate-200 max-sm:text-center">More</h1>
                    </div>
                    <div>
                        <div className="p-5 h-full bg-gray-300 ">
                            <div className="border-2 ">
                                ...
                                <img className=" mx-auto" height={300} width={250} src={rightSideImage} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
